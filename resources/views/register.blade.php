...
<section class="m-3 sm-m-2 main">
    <form class="container-fluid" action="entretenimiento.crear" method="POST">
        <div class="row">
            <div class="col-lg-6 col-sm-12">
                <div class="row p-3 ">
                    ...
                    <div class="form-floating col-lg-8 col-sm-12 mb-3">
                        <input type="text" name="nombre" class="form-control" id="floatingInput" maxlength="100" required>
                    ...
                    <div class="form-general col-lg-4 col-sm-12  text-center mb-3">
                        ...
                        <input id="floatingInput" name="anio_estreno" TYPE="NUMBER" MIN="1800" MAX="2021" STEP="1" VALUE="2019" SIZE="4"
                            required>
                    </div>
                    <div class="form-floating col-lg-12 ">
                        <textarea class="form-control" name="descripcion" id="floatingTextarea2" style="height: 150px" maxlength="300" required></textarea>
